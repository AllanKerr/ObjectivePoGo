//
//  PGCompleteTutorialStateRequest.m
//  ObjectivePoGo
//
...
@implementation PGCompleteTutorialStateRequest
...
- (instancetype)initWithState:(TutorialState)state {
    if (self = [super initWithType:RequestType_MarkTutorialComplete]) {
        ...
        [message.tutorialsCompletedArray addValue:state];
        if (state == TutorialState_LegalScreen) {
