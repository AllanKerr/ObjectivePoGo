...
// imports needed when using CocoaPods.
 ...
 #import "POGOProtos/Networking/Requests/Messages/GetPlayerProfileMessage.pbobjc.h"
// @@protoc_insertion_point(imports)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"

#pragma mark - GetPlayerProfileMessageRoot

@implementation GetPlayerProfileMessageRoot

@end

#pragma mark - GetPlayerProfileMessageRoot_FileDescriptor

static GPBFileDescriptor *GetPlayerProfileMessageRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[GetPlayerProfileMessage class]
                                     rootClass:[GetPlayerProfileMessageRoot class]
                                          file:GetPlayerProfileMessageRoot_FileDescriptor()
                                        fields:fields
