...
// imports needed when using CocoaPods.
 ...
 #import "POGOProtos/Networking/Requests/Messages/SetBuddyPokemon.pbobjc.h"
// @@protoc_insertion_point(imports)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"

#pragma mark - SetBuddyPokemonRoot

@implementation SetBuddyPokemonRoot

@end

#pragma mark - SetBuddyPokemonRoot_FileDescriptor

static GPBFileDescriptor *SetBuddyPokemonRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[SetBuddyPokemonMessage class]
                                     rootClass:[SetBuddyPokemonRoot class]
                                          file:SetBuddyPokemonRoot_FileDescriptor()
                                        fields:fields
