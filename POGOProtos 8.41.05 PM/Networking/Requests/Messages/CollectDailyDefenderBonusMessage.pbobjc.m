...
// imports needed when using CocoaPods.
 ...
 #import "POGOProtos/Networking/Requests/Messages/CollectDailyDefenderBonusMessage.pbobjc.h"
// @@protoc_insertion_point(imports)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"

#pragma mark - CollectDailyDefenderBonusMessageRoot

@implementation CollectDailyDefenderBonusMessageRoot

@end

#pragma mark - CollectDailyDefenderBonusMessageRoot_FileDescriptor

static GPBFileDescriptor *CollectDailyDefenderBonusMessageRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[CollectDailyDefenderBonusMessage class]
                                     rootClass:[CollectDailyDefenderBonusMessageRoot class]
                                          file:CollectDailyDefenderBonusMessageRoot_FileDescriptor()
                                        fields:NULL
                                    fieldCount:0
