...
#pragma mark - BadgeSettingsRoot

@implementation BadgeSettingsRoot
...
#pragma mark - BadgeSettingsRoot_FileDescriptor

static GPBFileDescriptor *BadgeSettingsRoot_FileDescriptor(void) {
  // This is called by +initialize so there is no need to worry
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[BadgeSettings class]
                                     rootClass:[BadgeSettingsRoot class]
                                          file:BadgeSettingsRoot_FileDescriptor()
                                        fields:fields
