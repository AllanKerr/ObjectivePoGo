...
#pragma mark - PotionAttributesRoot

@implementation PotionAttributesRoot

@end

#pragma mark - PotionAttributesRoot_FileDescriptor

static GPBFileDescriptor *PotionAttributesRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[PotionAttributes class]
                                     rootClass:[PotionAttributesRoot class]
                                          file:PotionAttributesRoot_FileDescriptor()
                                        fields:fields
