...
#pragma mark - ReviveAttributesRoot

@implementation ReviveAttributesRoot

@end

#pragma mark - ReviveAttributesRoot_FileDescriptor

static GPBFileDescriptor *ReviveAttributesRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ReviveAttributes class]
                                     rootClass:[ReviveAttributesRoot class]
                                          file:ReviveAttributesRoot_FileDescriptor()
                                        fields:fields
