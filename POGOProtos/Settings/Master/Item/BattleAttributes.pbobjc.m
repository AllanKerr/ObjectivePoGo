...
#pragma mark - BattleAttributesRoot

@implementation BattleAttributesRoot

@end

#pragma mark - BattleAttributesRoot_FileDescriptor

static GPBFileDescriptor *BattleAttributesRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[BattleAttributes class]
                                     rootClass:[BattleAttributesRoot class]
                                          file:BattleAttributesRoot_FileDescriptor()
                                        fields:fields
