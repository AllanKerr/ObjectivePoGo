...
#pragma mark - CameraAttributesRoot

@implementation CameraAttributesRoot

@end

#pragma mark - CameraAttributesRoot_FileDescriptor

static GPBFileDescriptor *CameraAttributesRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[CameraAttributes class]
                                     rootClass:[CameraAttributesRoot class]
                                          file:CameraAttributesRoot_FileDescriptor()
                                        fields:fields
