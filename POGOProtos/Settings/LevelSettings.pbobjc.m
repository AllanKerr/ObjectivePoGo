...
#pragma mark - LevelSettingsRoot

@implementation LevelSettingsRoot

@end

#pragma mark - LevelSettingsRoot_FileDescriptor

static GPBFileDescriptor *LevelSettingsRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[LevelSettings class]
                                     rootClass:[LevelSettingsRoot class]
                                          file:LevelSettingsRoot_FileDescriptor()
                                        fields:fields
