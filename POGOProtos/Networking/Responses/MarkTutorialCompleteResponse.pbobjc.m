...
@implementation MarkTutorialCompleteResponseRoot
...
#pragma mark - MarkTutorialCompleteResponseRoot_FileDescriptor

static GPBFileDescriptor *MarkTutorialCompleteResponseRoot_FileDescriptor(void) {
  // This is called by +initialize so there is no need to worry
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[MarkTutorialCompleteResponse class]
                                     rootClass:[MarkTutorialCompleteResponseRoot class]
                                          file:MarkTutorialCompleteResponseRoot_FileDescriptor()
                                        fields:fields
