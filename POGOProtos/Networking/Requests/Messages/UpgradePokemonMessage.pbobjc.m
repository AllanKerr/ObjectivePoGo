...
// imports needed when using CocoaPods.
 ...
 #import "POGOProtos/Networking/Requests/Messages/UpgradePokemonMessage.pbobjc.h"
// @@protoc_insertion_point(imports)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"

#pragma mark - UpgradePokemonMessageRoot

@implementation UpgradePokemonMessageRoot

@end

#pragma mark - UpgradePokemonMessageRoot_FileDescriptor

static GPBFileDescriptor *UpgradePokemonMessageRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[UpgradePokemonMessage class]
                                     rootClass:[UpgradePokemonMessageRoot class]
                                          file:UpgradePokemonMessageRoot_FileDescriptor()
                                        fields:fields
