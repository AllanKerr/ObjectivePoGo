...
@interface CheckCodenameAvailableMessageRoot : GPBRootObject
@end

#pragma mark - CheckCodenameAvailableMessage

typedef GPB_ENUM(CheckCodenameAvailableMessage_FieldNumber) {
  CheckCodenameAvailableMessage_FieldNumber_Codename = 1,
};

@interface CheckCodenameAvailableMessage : GPBMessage
