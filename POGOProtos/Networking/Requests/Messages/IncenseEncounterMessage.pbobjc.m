...
// imports needed when using CocoaPods.
 ...
 #import "IncenseEncounterMessage.pbobjc.h"
// @@protoc_insertion_point(imports)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"

#pragma mark - IncenseEncounterMessageRoot

@implementation IncenseEncounterMessageRoot

@end

#pragma mark - IncenseEncounterMessageRoot_FileDescriptor

static GPBFileDescriptor *IncenseEncounterMessageRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[IncenseEncounterMessage class]
                                     rootClass:[IncenseEncounterMessageRoot class]
                                          file:IncenseEncounterMessageRoot_FileDescriptor()
                                        fields:fields
