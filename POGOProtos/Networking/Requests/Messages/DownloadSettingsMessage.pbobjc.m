...
// imports needed when using CocoaPods.
 ...
 #import "POGOProtos/Networking/Requests/Messages/DownloadSettingsMessage.pbobjc.h"
// @@protoc_insertion_point(imports)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"

#pragma mark - DownloadSettingsMessageRoot

@implementation DownloadSettingsMessageRoot

@end

#pragma mark - DownloadSettingsMessageRoot_FileDescriptor

static GPBFileDescriptor *DownloadSettingsMessageRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[DownloadSettingsMessage class]
                                     rootClass:[DownloadSettingsMessageRoot class]
                                          file:DownloadSettingsMessageRoot_FileDescriptor()
                                        fields:fields
