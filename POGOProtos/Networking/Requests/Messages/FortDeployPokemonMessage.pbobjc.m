...
// imports needed when using CocoaPods.
 ...
 #import "POGOProtos/Networking/Requests/Messages/FortDeployPokemonMessage.pbobjc.h"
...
@implementation FortDeployPokemonMessageRoot

@end

#pragma mark - FortDeployPokemonMessageRoot_FileDescriptor

static GPBFileDescriptor *FortDeployPokemonMessageRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[FortDeployPokemonMessage class]
                                     rootClass:[FortDeployPokemonMessageRoot class]
                                          file:FortDeployPokemonMessageRoot_FileDescriptor()
                                        fields:fields
