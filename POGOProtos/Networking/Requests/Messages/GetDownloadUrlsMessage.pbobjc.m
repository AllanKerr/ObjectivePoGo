...
// imports needed when using CocoaPods.
 ...
 #import "GetDownloadUrlsMessage.pbobjc.h"
// @@protoc_insertion_point(imports)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"

#pragma mark - GetDownloadUrlsMessageRoot

@implementation GetDownloadUrlsMessageRoot

@end

#pragma mark - GetDownloadUrlsMessageRoot_FileDescriptor

static GPBFileDescriptor *GetDownloadUrlsMessageRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[GetDownloadUrlsMessage class]
                                     rootClass:[GetDownloadUrlsMessageRoot class]
                                          file:GetDownloadUrlsMessageRoot_FileDescriptor()
                                        fields:fields
